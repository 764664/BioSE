...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    return {
	        loadData: function loadData() {
	            ...
	            xmlhttp.onload = function () {
	                ...
	                //waitingDialog.hide();
	                $('.modal').modal('hide');
	                _reactDom2.default.render(_react2.default.createElement(OutPut, { papers: j["result"], pages: j["result_info"]["page"], current: page, searchid: j["result_info"]["id"], alert: '' }), document.getElementById("result"));
	                _reactDom2.default.render(_react2.default.createElement(
	                    'span',
	                    { className: 'navbar-text' },
	                    j["result_info"]["count"] + " results found."
	                ), document.getElementById("span_num_results"));
	                _reactDom2.default.render(_react2.default.createElement(OrderBy, null), document.getElementById("span_order_by"));
	                _reactDom2.default.render(_react2.default.createElement(Filter, { words: j["result_info"]["words"] }), document.getElementById("filter_container"));
	            }.bind(this);
	            xmlhttp.ontimeout = function () {
	                ...
	                _reactDom2.default.render(_react2.default.createElement(
	                    ...
	                    null,
	                    'AJAX Timeout.'
	                ), document.getElementById("num_results"));
	                $('.modal').modal('toggle');
	            };
	        ...
	        loadInitialData: function loadInitialData() {
	            var p_keyword = arguments.length <= 0 || arguments[0] === undefined ? keyword : arguments[0];
	            var p_page = arguments.length <= 1 || arguments[1] === undefined ? 1 : arguments[1];
	            var p_order_by = arguments.length <= 2 || arguments[2] === undefined ? "Default" : arguments[2];
	            var p_filter_by = arguments.length <= 3 || arguments[3] === undefined ? "Default" : arguments[3];
	        ...
	        loadNewPage: function loadNewPage(p) {
	            page = p;
	...
	var InstantSearch = _react2.default.createClass({
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                this.props.terms.map(function (term, index) {
	                    return _react2.default.createElement(
	                        'li',
	                        { key: index, onClick: this.props.click },
	                        term
	                    );
	                }, this)
	            )
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'li',
	                    { onClick: this.handleClick.bind(this, 0), id: 'showall' },
	                    'Show All'
	                ),
	...
	var OrderBy = _react2.default.createClass({
	    displayName: 'OrderBy',
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            'div',
	            { className: 'btn-group navbar-btn', id: 'order_by' },
	            _react2.default.createElement(
	                'button',
	...
	var Alerting = _react2.default.createClass({
	...
	var Detail = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'a',
	                { href: "/jump/" + this.props.searchid + "/" + this.props.paper["ID"] },
	    ...
	    render: function render() {
	        ...
	        if (paper["Citations"]) {
	            if (paper["Citations_URL"]) {
	                citation_url = _react2.default.createElement(
	                    'a',
	                    { href: paper["Citations_URL"] },
	                    _react2.default.createElement(
	                        'span',
	                        { className: 'label label-blue citations' },
	                        'Citations: ',
	                        paper["Citations"]
	                    )
	                );
	            ...
	            citation_url = _react2.default.createElement('span', null);
	        }
	        return _react2.default.createElement(
	            'li',
	            { className: "list-group-item " + this.state.selected },
	            _react2.default.createElement(
	                'div',
	                { className: 'div_title' },
	                _react2.default.createElement(
	                    'a',
	                    { href: '#', onClick: this.showDetails },
	                    _react2.default.createElement(
	                        'span',
	                        { className: 'label label-dark title', id: "h" + paper["PMID"] },
	                        paper["Title"]
	                    )
	                )
	            ),
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    paper["Author"].map(function (author, index) {
	                        ...
	                        return _react2.default.createElement(
	                            'span',
	                            { className: 'label label-default author', key: index },
	                            _react2.default.createElement(
	                                'a',
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'span',
	                    { className: 'label label-info journal' },
	                    _react2.default.createElement(
	                        'a',
	                        { target: '_blank', href: "http://google.com/search?btnI=1&q=" + paper["Journal"] },
	                        paper["Journal"] ? "Journal: " + paper["Journal"] : "Journal: Unknown"
	                    )
	                ),
	                _react2.default.createElement(
	                    'span',
	                    { className: 'label label-success pubdate' },
	                    paper["PubDate"] ? "PubDate: " + paper["PubDate"] : "PubDate: Unknown"
	                ),
	                _react2.default.createElement(
	                    'span',
	                    { className: 'label label-warning score' },
	                    paper["Score"] ? "Score: " + paper["Score"].toFixed(2) : ""
	                ),
	                citation_url,
	                _react2.default.createElement(Detail, { content: this.state.detail, paper: paper, searchid: searchid })
	            )
	        );
	    }
	});

	var PaperList = _react2.default.createClass({
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    papers.map(function (paper, index) {
	                        return _react2.default.createElement(Paper, { paper: paper, searchid: searchid, key: index });
	                    }, this)
	                )
	            );
	        } else {
	    ...
	    render: function render() {
	        ...
	        var pageli = function (item, index) {
	            if (item <= pages) {
	                return _react2.default.createElement(
	                    'li',
	                    { key: index, onClick: this.handleClick, 'data-id': item, className: (item == current ? "active" : "") + " " + (item > pages ? "disabled" : "") },
	                    _react2.default.createElement(
	                        'a',
	                        null,
	                        item
	                ...
	                return _react2.default.createElement(
	                    'li',
	                    { key: index, 'data-id': item, className: (item == current ? "active" : "") + " " + (item > pages ? "disabled" : "") },
	                    _react2.default.createElement(
	                        'a',
	                        null,
	                        item
	        ...
	        if (pages > 0) {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'container mypagination' },
	                    _react2.default.createElement(
	                        'nav',
	                        null,
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'li',
	                                { className: current == 1 ? "disabled" : "", onClick: this.handleClick, 'data-id': 1 },
	                                _react2.default.createElement(
	                                    'a',
	                            ...
	                            _react2.default.createElement(
	                                'li',
	                                { onClick: this.handleClick, 'data-id': pages },
	                                _react2.default.createElement(
	                                    'a',
	...
	var OutPut = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement(Alerting, { message: this.props.alert }),
	            _react2.default.createElement(PaperList, { papers: this.props.papers, searchid: this.props.searchid }),
	            _react2.default.createElement(Pagination, { pages: this.props.pages, current: this.props.current })
	        );
	    }
	});
	    ...
	    onChange: function onChange(e) {
	        ...
	        if (e.target.value.length > 0) {
	            ...
	            xmlhttp.onload = function () {
	                var j = JSON.parse(xmlhttp.responseText);
	                if (j.length > 0) {
	                    _reactDom2.default.render(_react2.default.createElement(InstantSearch, { terms: j, click: this.handleClick }), document.getElementById("instant"));
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'form',
	                        { id: 'form_search', className: 'navbar-form', onSubmit: this.handleSubmit },
	                        _react2.default.createElement('input', { className: 'form-control', id: 'main_search', onChange: this.onChange, value: this.state.text, placeholder: 'Search', autoComplete: 'off' }),
	                        _react2.default.createElement('div', { id: 'instant' }),
	                        _react2.default.createElement(
	                            'button',
	                            { className: 'btn btn-primary', id: 'search_button' },
	                            'Search'
	                        )
	                    ),
	                    _react2.default.createElement('span', { id: 'span_num_results' }),
	                    _react2.default.createElement('span', { id: 'span_order_by' })
	                )
	            )
	        );
	    }
	...
	var WaitingDialog = _react2.default.createClass({
	    displayName: 'WaitingDialog',

	    render: function render() {
	        return _react2.default.createElement(
	            'div',
	            { className: 'modal fade', 'data-backdrop': 'static', 'data-keyboard': 'false', tabIndex: '-1', role: 'dialog', 'aria-hidden': 'true' },
	            _react2.default.createElement(
	                'div',
	...
	_reactDom2.default.render(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        _reactRouter.Route,
	        { path: '/', component: App },
	        _react2.default.createElement(_reactRouter.Route, { path: '/search/:keyword', component: '{App}' })
	    )
	), document.getElementById("form"));
	// ReactDOM.render(<App />, document.getElementById("form"));
	_reactDom2.default.render(_react2.default.createElement(WaitingDialog, null), document.getElementById("waitingdialog"));
	//
